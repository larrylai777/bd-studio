...
export default function Film() {
  return <MediaStage data={{
    ...
    image: "assets/footer-archive.webp", imageAlt: "無限絲帶與檔案紙組成的電影世界觀抽象視覺", focal: "FEATURE FILM · A WORLD WORTH RETURNING TO", progress: "長期電影改編與世界觀資產整理", next: "回到原作起點", nextHref: `${import.meta.env.BASE_URL}original/`, icon: null as never,
    steps: [
