...
export default function Home() { return <div className="entertainment-site" id="top"><SiteHeader current="home" /><main>
  ...
  <section className="signal-band"><div><p className="eyebrow">STUDIO SIGNAL / 04</p><h2>故事不會停在一種形式。</h2></div><p>每一次轉譯，都讓同一個世界以更精準的語言被重新看見。</p><a href={`${assetBase}support/`}>支持故事前進 <ArrowRight size={17} /></a></section>
</main><SiteFooter /></div>; }
