...
export default function Original() {
  return <MediaStage data={{
    ...
    image: "assets/hero-cosmos.webp", imageAlt: "淡紫宇宙軌道構成的第九次出生原作視覺", focal: "第九次出生 · 科幻懸疑長篇", progress: "第四部《第一次出生》連載中", next: "收聽 Tell 播客", nextHref: `${import.meta.env.BASE_URL}podcast/`, icon: null as never, signatureMark: "assets/original-mark.webp",
    steps: [
      { label: "世界觀檔案", detail: "建立規則、時間線與角色命題，讓故事能夠跨媒介生長。", state: "done" },
      { label: "小說連載", detail: "以卷冊和章節累積讀者關係，持續打磨角色的核心選擇。", state: "active" },
      { label: "改編藍圖", detail: "將敘事節點整理為聲音、場次與鏡頭語言的共同依據。", state: "next" },
    ],
  }} />;
}
