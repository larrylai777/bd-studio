...
export default function Original() {
  return <MediaStage data={{
    ...
    image: "assets/hero-cosmos.webp", imageAlt: "淡紫宇宙軌道構成的第九次出生原作視覺", focal: "第九次出生 · 科幻懸疑長篇", progress: "第四部《第一次出生》連載中", next: "查看漫畫開發", nextHref: `${import.meta.env.BASE_URL}comic/`, icon: null as never,
    steps: [
