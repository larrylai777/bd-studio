...
export default function Series() {
  return <MediaStage data={{
    ...
    description: "從小說與 Tell 播客累積的世界觀出發，比爸工作室將建構影集聖經、季節主線與單集節奏，讓每一次停播都保留回到故事的理由。",
    image: "assets/reading-dawn.webp", imageAlt: "霧中門框與黎明組成的影集企劃抽象視覺", focal: "SEASON ONE · THE CITY AFTER DAWN", progress: "系列聖經與第一季主線規劃", next: "查看電影計畫", nextHref: `${import.meta.env.BASE_URL}film/`, icon: null as never, signatureMark: "assets/series-mark.webp",
    steps: [
